	...
	<form action="qnaUpdate" method="post">
		...
		<table class="table table-bordered">
			<tr>
				...
				<td><input class="title" type="text" name="title" required="required" value="${qna.title }"></td>
				<td class="table-title">작성자</td>
				<td><input class="writer" type="text" name="writer" readonly="readonly" value="${qna.writer}"></td>
			</tr>
			<tr>
				<td class="table-title">내용</td>
				<td colspan="3"><textarea name="contents"rows="" cols="">${qna.contents}</textarea></td>
			</tr>
		</table>
		<div id="btn">
